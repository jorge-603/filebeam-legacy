...
function addLog ($fileName, $hash) {
    ...
    $stmt1 = $conn->prepare("INSERT INTO logs (timestamp, date_time, user_agent, ip_addr, file_name, hash) VALUES (:timestamp, :date_time, :user_agent, :ip_addr, :file_name, :hash)");
